...
class AuthController extends Controller
{
    ...
    public function attemptRegister()
    {
        ...
        // Save additional user details to the 'pembeli' table
        $pembeliModel = new PembeliModel();

        $pembeliData = [
            'nama'          => $this->request->getPost('nama'),
            'telepon'       => $this->request->getPost('telepon'),
            'fk_id_kecamatan'  => $this->request->getPost('kecamatan'), // Ubah 'id_kecamatan' menjadi 'fk_id_kecamatan'
            'fk_id_desa'       => $this->request->getPost('desa'), // Ubah 'id_desa' menjadi 'fk_id_desa'
            'alamat'        => $this->request->getPost('detail_alamat'), // Ubah 'detail_alamat' menjadi 'alamat'
            'email'         => $this->request->getPost('email')
        ];

        $pembeliModel->insert($pembeliData);
