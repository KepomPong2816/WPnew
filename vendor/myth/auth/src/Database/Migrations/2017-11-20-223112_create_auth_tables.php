...
class CreateAuthTables extends Migration
{
    public function up()
    {
        ...
        // Pembeli
        $this->forge->addField([
            'id_pembeli' => ['type' => 'int', 'constraint' => 11, 'unsigned' => true, 'auto_increment' => true],
            'nama'       => ['type' => 'varchar', 'constraint' => 255],
            'alamat'     => ['type' => 'varchar', 'constraint' => 255],
            'telepon'    => ['type' => 'varchar', 'constraint' => 25],
            'email'      => ['type' => 'varchar', 'constraint' => 255],
        ]);

        $this->forge->addKey('id_pembeli', true);
        $this->forge->addForeignKey('email', 'users', 'email', '', 'CASCADE');
        $this->forge->createTable('pembeli', true);

        // Toko
        $this->forge->addField([
            'id_toko'    => ['type' => 'int', 'constraint' => 11, 'unsigned' => true, 'auto_increment' => true],
            'nama_toko'  => ['type' => 'varchar', 'constraint' => 255],
            'id_pembeli' => ['type' => 'int', 'constraint' => 11, 'unsigned' => true],
        ]);

        $this->forge->addKey('id_toko', true);
        $this->forge->addForeignKey('id_pembeli', 'pembeli', 'id_pembeli', '', 'CASCADE');
        ...
        $this->forge->addField([
            ...
            'foto_barang'   => ['type' => 'varchar', 'constraint' => 255],
            'id_kategori'   => ['type' => 'int', 'constraint' => 11, 'unsigned' => true],
            'id_toko'       => ['type' => 'int', 'constraint' => 11, 'unsigned' => true],
            'created_at'    => ['type' => 'datetime', 'null' => true],
            'updated_at'    => ['type' => 'datetime', 'null' => true],
        ]);
        ...
        $this->forge->addForeignKey('id_toko', 'toko', 'id_toko', '', 'CASCADE');
        ...
        $this->forge->addField([
            ...
            'tanggal_beli'   => ['type' => 'datetime'],
        ]);

        $this->forge->addKey('id_transaksi', true);
        $this->forge->addForeignKey('id_pembeli', 'pembeli', 'id_pembeli', '', 'CASCADE');
        $this->forge->addForeignKey('id_barang', 'barang', 'id_barang', '', 'CASCADE');
    ...
    public function down()
    {
        ...
        $this->forge->dropTable('pembeli', true);
    }
}
